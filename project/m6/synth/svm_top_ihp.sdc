...
# Hold analysis: minimum path constraints (excludes false-path SPI/SRAM inputs)
set_input_delay  -clock clk -min 0.0 [get_ports rst_n]
set_output_delay -clock clk -min 0.0 [get_ports ram_addr_out]
set_output_delay -clock clk -min 0.0 [get_ports ram_ren_out]
set_output_delay -clock clk -min 0.0 [get_ports class_out]
set_output_delay -clock clk -min 0.0 [get_ports sample_rdy]
set_output_delay -clock clk -min 0.0 [get_ports done]
set_output_delay -clock clk -min 0.0 [get_ports error]
set_output_delay -clock clk -min 0.0 [get_ports error_code]
set_output_delay -clock clk -min 0.0 [get_ports irq_sample_rdy]
set_output_delay -clock clk -min 0.0 [get_ports irq_done]
set_output_delay -clock clk -min 0.0 [get_ports spi_miso]
