...
// ============================================================================
// Multi-Class Cardiac Arrhythmia Detection — SVM Compute Core  v11  (batch)
...
//
// v11 changes vs v10:
//   - NUM_SV expanded 500 -> 600; alpha_addr widened to 10-bit
//   - Allocation [120,120,120,120,120] uniform -> 98.67% Q6.10, 0 flips
//   - NUM_SV reset defaults 8'd50 -> 8'd120 (sticky startup default)
//   - Target process: IHP SG13G2 130nm (standalone, no Caravel wrapper)
//
// Off-chip address map  (row x FEATURE_DIM layout, FEATURE_DIM = 256 = 2^8):
//   Rows  0 .. NUM_SV-1              SV matrix      (600 x 256 = 153 600 words)
//   Rows  NUM_SV .. NUM_SV+batch-1   input matrix   (1000 x 256 = 256 000 words)
//   Maximum address: (600 + 1000) x 256 - 1 = 409 599  ->  19-bit address bus
//
// Per-sample output:
