# Testbench Summary — svm_compute_core (ECE410, m4)
...
`tb_wb_unit.py` replaces the legacy m2 QSPI/FIFO tests with 7 targeted Wishbone interface
...
| Test | Sim Time | Result | What it covers (replaces m2 test) |
|------|----------|--------|------------------------------------|
...
| 3 — Feature/Parameter | Direct RTL | iverilog | m4/tb/ | 1 | **1/1 PASS** |
| 4 — Wishbone Unit | Wishbone (wrapper) | cocotb | m4/tb/ | 7 | **7/7 PASS** |
| 5 — System | Wishbone (wrapper) | cocotb | m4/tb/ | 1 | **PASS — 97.67%** |
| 6 — Platform DV | Wishbone (full SoC) | Caravel DV | m4/tb/ | 1 | **RTL sim complete** |
| **Total** | | | | **32** | **32/32 PASS** |

*ECE410 — Portland State University · Adam Handwerger · m4*
